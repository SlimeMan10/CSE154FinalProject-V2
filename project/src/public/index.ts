...
import { checkIfStrong, verifyPassword } from './users/passwordEvents.js';
import { Product, PaymentFields, purchaseFields } from './objects/types.js';
"use strict";
(function() {
   ...
   */
    async function displayAllProducts() : Promise<void> {
      try {
